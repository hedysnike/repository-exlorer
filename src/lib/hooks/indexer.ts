...
// import { RepositoryStatus, PrismaClient, Document, Prisma } from "@prisma/client";
// import { Document as LangchainDocument } from "langchain/document"; // Adjust the import path if necessary
// import { prisma } from "../db";

// // ეს კოდი ავიღე აქედან https://github.com/mbarinov/repogpt/blob/main/src/services/indexer/index.ts
...
//     const vectorStore = PrismaVectorStore.withModel<Document>(this.db).create(embeddings, {
//       prisma: Prisma,
//       tableName: "Document",
